...
<blockquote><b>๏ Perintah: {0}addnote
◉ Penjelasan: Menyimpan Sebuah Catatan</b></blockquote>
<blockquote><b>๏ Perintah: {0}get
◉ Penjelasan: Mendapatkan Catatan Yang Di Simpan</b></blockquote>
<blockquote><b>๏ Perintah: {0}delnote
◉ Penjelasan: Menghapus Catatan Yang Di Simpan</b></blockquote>
<blockquote><b>๏ Perintah: {0}listnote
◉ Penjelasan: Melihat Daftar Catatan Yang Di Simpan</b></blockquote>
<blockquote><b>๏ Format: | Nama Tombol - Url/Callback |
◉ Penjelasan: untuk membuat button pada catatan</b></blockquote>
...
async def _(client, message):
    ...
    if value:
        ...
        return await message.reply(
            f"<b>ᴄᴀᴛᴀᴛᴀɴ <code>{args}</code> Berhasil Tersimpan</b>"
        )
    else:
        return await message.reply(
...
async def _(client, message):
    ...
    return await message.reply(f"<b>catatan {args} Berhasil Di Hapus</b>")
...
async def _(client, message):
    ...
    if not data:
        return await message.reply(
            f"<b>Catatan {args} Tidak Ditemukan</b>"
        )
