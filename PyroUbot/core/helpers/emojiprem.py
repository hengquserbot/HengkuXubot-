...
class EMO:
    async def PING1(client):
        ...
        ping1 = emot_1 if emot_1 else "6127475690531982315"
    ...
    async def PING2(client):
        ...
        ping2 = emot_2 if emot_2 else "5971944878815317190"
        if client.me.is_premium:
    ...
    async def PING3(client):
        ...
        ping3 = emot_3 if emot_3 else "6167848082466671702"
        if client.me.is_premium:
    ...
    async def SUKSES(client):
        ...
        sukses = emot_4 if emot_4 else "6113647841459047673"
        if client.me.is_premium:
    ...
    async def GAGAL(client):
        ...
        gagal = emot_5 if emot_5 else "6113872536968104754"
        if client.me.is_premium:
    ...
    async def PROSES(client):
        ...
        proses = emot_6 if emot_6 else "6113844439292054570"
        if client.me.is_premium:
